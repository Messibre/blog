      ...
      <div className="prose-manuscript text-foreground/90">
        <ReactMarkdown
          components={{
            ...
            h1: ({ children }) => <h1 className="font-[family-name:var(--font-playfair)] text-3xl mt-10 mb-4">{children}</h1>,
            h2: ({ children }) => <h2 className="font-[family-name:var(--font-playfair)] text-2xl mt-8 mb-3">{children}</h2>,
            h3: ({ children }) => <h3 className="font-[family-name:var(--font-playfair)] text-xl mt-6 mb-2">{children}</h3>,
            blockquote: ({ children }) => (
            ...
            pre: ({ children }) => (
              <pre className="bg-muted p-4 rounded overflow-x-auto mb-6 text-sm">{children}</pre>
            ),
